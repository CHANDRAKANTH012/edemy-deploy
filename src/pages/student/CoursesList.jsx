...
//   const [filteredCourse, setFilteredCourse] = useState([]); // [] ->empty
        ...
        <div className="course-list-header">
          <div className="header-content">
            <div className="title-section">
              ...
              <div className="breadcrumb">
                <span onClick={() => navigate("/")} className="breadcrumb-home">
                  Home
                </span>
                <span className="breadcrumb-separator">/</span>
                <span className="breadcrumb-current">Course List</span>
              </div>
            </div>
          ...
          {input && (
            <div className="search-tag">
              <span className="search-term">{input}</span>
              <img
