  ...
  return (
    ...
    >
      ...
      <div className="course-content">
        ...
        <p className="course-educator">{course.educator.name}</p>
        <div className="course-rating-container">
          <p className="course-rating-number">{calculateRating(course)}</p>
          ...
          <p className="course-rating-count">{course.courseRatings.length}</p>
        </div>
